...
contextBridge.exposeInMainWorld("prototypeStudio", {
  ...
  pickExternalPrototypeFile: (request) => ipcRenderer.invoke("project:pick-external-prototype-file", request),
  ...
  pickExternalRsiFolder: (request) => ipcRenderer.invoke("asset:pick-external-rsi-folder", request),
  createExternalRsi: (request) => ipcRenderer.invoke("asset:create-external-rsi", request),
  getLocaleAsset: (path) => ipcRenderer.invoke("asset:get-locale", path),
  saveLocaleAsset: (request) => ipcRenderer.invoke("asset:save-locale", request),
  createLocaleAsset: (draft) => ipcRenderer.invoke("asset:create-locale", draft),
  pickExternalLocaleFile: (request) => ipcRenderer.invoke("asset:pick-external-locale-file", request),
  createExternalLocale: (request) => ipcRenderer.invoke("asset:create-external-locale", request),
  analyzePrototypeLocalization: (request) => ipcRenderer.invoke("project:analyze-prototype-localization", request),
  createPrototypeLocalization: (request) => ipcRenderer.invoke("project:create-prototype-localization", request),
